...
├── data/loan_data.csv          # dataset (8,000 loan applicants)
├── src/
│   ├── 01_generate_data.py     # data generation
│   ├── 02_eda.py                # exploratory analysis
│   └── 03_modeling.py           # feature engineering + modeling + evaluation
├── plots/                       # all charts (7 PNGs)
├── results.json                 # final model metrics
└── README.md
```
